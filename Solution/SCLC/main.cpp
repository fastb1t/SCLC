...
{
    const TCHAR szWindowName[] = _T("SCLC");                    // Заголовок програми.
    const TCHAR szClassName[] = _T("__sclc__class__");          // І'мя класу вікна.
    const TCHAR szMutexName[] = _T("__sclc__mutex__");          // І'мя м'ютекса.
